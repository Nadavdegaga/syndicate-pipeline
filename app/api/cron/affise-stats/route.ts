// Vercel Cron — runs daily at 02:00 UTC to ingest the previous day's Affise stats.
...
import { syncAffiseStatsForDate } from "@/lib/affise/sync-stats";
...
async function handle(request: Request) {
  ...
  const result = await syncAffiseStatsForDate(date);
